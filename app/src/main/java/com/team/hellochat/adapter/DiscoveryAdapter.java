...
public class DiscoveryAdapter extends BaseRecyclerAdapter<Discovery> {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder viewHolder, int position) {
        ...
        holder.tvSex.setText("年龄：" + discovery.getSex().getLabel());
        holder.tvAge.setText("性别：" + String.valueOf(discovery.getAge()));
    ...
    class DiscoveryViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        private TextView tvName, tvAge, tvSex, tvAddress;
        ...
        public void onClick(View v) {
            ...
            switch (v.getId()) {
                ...
                case R.id.ly_start_chat:
                    if (myCredit >= discovery.getCreditPoint() + 20) {
